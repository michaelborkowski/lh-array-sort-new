...
arrayTests :: TestTree
arrayTests = testGroup "Array Tests" [ testMakeArray, testArrayGetSet, testSwap, testSplit ] where
  ...
  testSwap = testGroup "Swap Tests" [ caseTests, performanceTests ] where
    ...
    caseTests :: TestTree
    caseTests = testGroup "Swap Case Tests" [ testValuesSwapped1, testValuesSwapped2, testValuesSwapped3, testValuesSwapped4, testSwapSameIndex ] where 
      ...
      -- Testing if swapping two elements works correctly.
      testValuesSwapped2 = valueSwapTest 5 0 0 1 1 2
      testValuesSwapped3 = valueSwapTest 10 1 1 2 2 4
      testValuesSwapped4 = valueSwapTest 20 1 2 3 4 5
