...
merge :: HasPrimOrd a => Array a -> Array a -> Array a -> Int -> Int -> Array a
...
msort :: HasPrimOrd a => Array a -> Array a -> Array a
...
topMSort :: HasPrimOrd a => Array a -> Array a
...
lma_merge_fix :: HasPrimOrd a => Array a -> Array a -> Array a -> Int -> Int -> Int -> Proof
...
lma_merge_max :: HasPrimOrd a => Array a -> Array a -> Array a -> Int -> Int -> a -> Proof
...
lma_merge :: HasPrimOrd a => Array a -> Array a -> Array a -> Int -> Int -> Proof
-- -- lma_merge [] ys _ _ = ()
...
lma_msort :: HasPrimOrd a => Array a ->  Array a -> Proof
lma_msort xs ys
  | (A.size xs == 0) = ()
  | (A.size xs == 1) = ()
  | otherwise        =
...
lma_merge_eq :: HasPrimOrd a => Array a -> Array a -> Array a -> Int -> Int -> Proof
...
lma_msort_eq :: HasPrimOrd a => Array a -> Array a -> Proof
lma_msort_eq xs ys
