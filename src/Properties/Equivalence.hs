...
lem_inBagBtw_index :: HasPrimOrd a => Array a -> Int -> Int -> a -> Int
...
lem_index_inBagBtw :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Proof
...
lem_equal_toBagBtw_index :: HasPrimOrd a => Array a -> Array a -> Int -> Int -> Int -> Int
...
lem_toBagBtw_slice :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Int -> Proof
...
lem_toBag_slice :: HasPrimOrd a => Array a -> Int -> Int -> Proof
...
lem_toBag_splitMid :: HasPrimOrd a => Array a -> Proof
...
lem_toBag_splitAt :: HasPrimOrd a => Int -> Array a -> Proof
...
lem_toBag_append :: HasPrimOrd a => Array a -> Array a -> Proof
...
lem_toBagBtw_inside_swap :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Int -> Proof
...
{-@ lem_toBagBtw_before_swap :: xs:(Array a) -> { i':Int | 0 <= i' } -> { j':Int | i' <= j' }
                             ...
                             -> { pf:_ | toBagBtw (swap xs i j) i' j' == toBagBtw xs i' j' } / [j'-i'] @-}
lem_toBagBtw_before_swap :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Int -> Proof
...
{-@ lem_toBagBtw_after_swap :: xs:(Array a) -> { i:Int | 0 <= i } -> { j:Int | i <= j }
                             -> { i':Int | j < i' } -> { j':Int | i' <= j' && j' <= A.size xs}
                             -> { pf:_ | toBagBtw (swap xs i j) i' j' == toBagBtw xs i' j' } / [j'-i'] @-}
lem_toBagBtw_after_swap :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Int -> Proof
...
lem_toBagBtw_swap :: HasPrimOrd a => Array a -> Int -> Int -> Proof
...
lem_bagBtw_swap :: HasPrimOrd a => Array a -> Int -> Int -> Int -> Int -> Proof
...
{-@ toSlice :: xs:(Array a) -> { i:Int | 0 <= i } -> { j:Int | i <= j && j <= A.size xs }
                            -> [a] / [j-i] @-}
toSlice :: (HasPrimOrd a, Eq a) => Array a -> Int -> Int -> [a]
toSlice xs i j | i == j     = []
...
lem_toSlice_set_left :: (HasPrimOrd a, Eq a) => Array a -> Int -> a -> Int -> Int -> Proof
...
{-@ lem_toSlice_set_right :: xs:_ -> { i:Nat | i < A.size xs } -> v:a
                                  ...
                                  -> { pf:_  | toSlice (A.set xs i v) l r == toSlice xs l r } / [r-l] @-}
lem_toSlice_set_right :: (HasPrimOrd a, Eq a) => Array a -> Int -> a -> Int -> Int -> Proof
...
lem_toSlice_set :: (HasPrimOrd a, Eq a) => Array a -> Int -> a -> Proof
...
lem_equal_slice_narrow :: (HasPrimOrd a, Eq a) => Array a -> Array a -> Int -> Int -> Int -> Int -> Proof
...
lem_toSlice_swap :: (HasPrimOrd a, Eq a) => Array a -> Int -> Int -> Int -> Int -> Proof
...
lem_equal_slice_sorted :: HasPrimOrd a => Array a -> Array a -> Int -> Int -> Int -> Int -> Proof
...
lem_copy_equal_slice :: (HasPrimOrd a, Eq a) => Array a -> Int -> Array a -> Int -> Int -> Proof
...
{-@ reflect toBagEqual @-}
toBagEqual :: HasPrimOrd a => Array a -> Array a -> Bool
...
lma_set_equal :: HasPrimOrd a => Array a -> a -> Int -> Int -> Proof
...
lma_toBag_toBagLeft :: HasPrimOrd a => Array a -> Int -> Proof
